...
if (is_integer($welcome_amount)) {
    $dis_duration = $welcome_amount;
} else {
    $dis_duration = 3;
}
session_start();
$_SESSION['first_load'] = $_SESSION['first_load'] + 1;
if ($_SESSION['first_load'] <= $welcome_amount) {
    $show_wel = true;
} else {
    $show_wel = false;
}
...
<html lang="en">
    <head>
        ...
        <script type='text/javascript'>
            var _chatnox = _chatnox || [];
            _chatnox.setAccount = '5165146533003264';
            var cnox = document.createElement('script');
            cnox.type = 'text/javascript';
            cnox.async = true;
            cnox.src = ('https:' == document.location.protocol ?
    ...
    <body <?php echo body_class(); ?>>
        ...
        //Send All Email
        $send_email_form = get_option('email_4');
        ...
        <header>
            ...
            if ($show_wel == true) {
                ...
                $dis_duration = $dis_duration * 1000;
                ?>
                <script type="text/javascript">
            ...
            <div class="top_bar">
                <div class="container">
                    <div class="row">
                        <!--Contact Info-->
                        <div class="quick_contact col-xs-12 col-sm-6 col-md-5 col-lg-4">
                            <ul>
                        ...
                        <div class="hidden-xs col-xs-12 col-sm-2 col-md-3 col-lg-2 col-lg-offset-3">
                            <div class="weather">
                                <?php
//                                $content =file_get_contents("http://api.openweathermap.org/data/2.5/weather?id=1185241&mode=xml&appid=1bc6553a459dcd63e395709cdc976c87&units=metric");
//                                $xml = simplexml_load_file("http://api.openweathermap.org/data/2.5/weather?q=Dhaka&mode=xml&appid=1bc6553a459dcd63e395709cdc976c87&units=metric");// or die("Error: Cannot create object");
                                $xml = simplexml_load_file("http://api.openweathermap.org/data/2.5/weather?id=1185241&mode=xml&appid=1bc6553a459dcd63e395709cdc976c87&units=metric"); // or die("Error: Cannot create object");
                                ?>
                                <img class="weather_icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/weather.png" alt="" />
                                <sup class="degree">
                                    <?php
                                    $wearch_number = round($xml->temperature['value'], 0, PHP_ROUND_HALF_UP);
                                    if (!empty($wearch_number)) {
                                        echo $wearch_number;
                                        ?>&#176<?php
                                        ;
                                    }
                        ...
                        <div class="social_links hidden-xs col-xs-12 col-sm-4 col-md-4 col-lg-3 pull-right">
                            <ul>
            ...
            <div class="banner">
                <div class="container">
                    <div class="row">
                        <div class="logo_section col-xs-12 col-sm-3 col-md-4 col-lg-3">
                        ...
                        <div class="opening_day_section col-xs-12 col-sm-9 col-md-5 col-lg-5 col-lg-offset-1">
                            <ul class="opening_day">
                                <li><a href="javascript:void(0)">Opening Day</a></li>
                                <li><a href="javascript:void(0)"><?= $weekly_first_day; ?> to <?= $weekly_last_day; ?>  <span><?= $office_opening_time; ?> - <?= $office_closing_time; ?></span></a></li>
                            </ul>
                        </div>
            ...
            <nav class="main_memu navbar navbar-default">
                <div class="container">
                    ...
                    <form role="search" class="search_form" method="get" action="<?php echo esc_url(home_url('/')); ?>">
                        <div class="form-group input_search">
