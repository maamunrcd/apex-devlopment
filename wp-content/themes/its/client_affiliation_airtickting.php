<?php
/**
 * Template Name: Content With Bottom Logo
 * 
 * The template for displaying Vission Mission affiliation
 *
 */
get_header();
            ...
            <div class="container">
                ...
                <div class="logo_items row">
                    ...
                    if ($pagename == "our-clients") {
                        ...
                        $all_logos = 1;
                        $client_loop = new WP_Query($client_logos);
                        while ($client_loop->have_posts()) : $client_loop->the_post();
                            ?>
                            <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                                <div class="single_logo_item sj animated fadeInUp" data-animate="fadeInUp" data-animation-delay="1000">
                                    <a target="_blink" href="<?php echo get_the_excerpt(); ?>">
                                        <?php the_post_thumbnail('full', array('class' => 'img-responsive')); ?>
                                        <span class="heading_title"><?php the_title(); ?></span>
                                    </a>
                                </div>
                            </div>
                            <?php
                        endwhile;
                    }elseif ($pagename == "air-ticketing") {
                        ?>
                    ...
                    <div class="logo_items row">
                        <?php
                        $air_ticketing_logos = array(
                            'post_type' => 'air_ticketing',
                            'posts_per_page' => -1,
                            'order' => 'ASC'
                        );
                        $all_logos = 1;
                        $air_ticketing_loop = new WP_Query($air_ticketing_logos);
                        while ($air_ticketing_loop->have_posts()) : $air_ticketing_loop->the_post();
                            ?>
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="single_logo_item sj animated fadeInUp" data-animate="fadeInUp" data-animation-delay="1000" style="animation-delay: 1000ms;">
                                    <a target="_blink" href="<?php echo get_the_excerpt(); ?>">
                                        <?php the_post_thumbnail('full', array('class' => 'img-responsive')); ?>
                                    </a>
                                </div>
                            ...
                            <?php
                        endwhile;
                    }else if ($pagename == "affiliation") {
                        $affiliations = array(
                            'post_type' => 'affiliation_section',
                            'posts_per_page' => -1,
                            'order' => 'ASC'
                        );
                        $all_logos = 1;
                        $affiliation_loop = new WP_Query($affiliations);
                        while ($affiliation_loop->have_posts()) : $affiliation_loop->the_post();
                            ?>
                            <div class="col-xs-12 col-sm-6 col-md-3">
                                <div class="single_logo_item sj animated fadeInUp" data-animate="fadeInUp" data-animation-delay="1000" style="animation-delay: 1000ms;">
